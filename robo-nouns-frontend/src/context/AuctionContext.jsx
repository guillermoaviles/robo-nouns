...
export function AuctionProvider({ children }) {
  ...
  const addNounData = (newNoun) => {
    const isDuplicate = nounNFTMeta ? nounNFTMeta.some((noun) => noun?.hash === newNoun?.hash) : false;
    if (!isDuplicate) {

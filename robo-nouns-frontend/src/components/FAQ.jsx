...
const faq = [
    ...
    },
    {
        ...
        description:
            "Robo Nouns are generated randomly based on block hashes. There are no 'if' statements or other rules governing Robo Noun trait scarcity, which makes all Robo Nouns equally rare. As of this writing, Robo Nouns are made up of: backgrounds (1), bodies (1), accessories (140), heads (242), glasses (23).",
    },
    {
